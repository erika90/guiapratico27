...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url('publico');?>">BravaCar</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" <?php echo setMenuActiveItem($active_menu=='frota')?>>
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url('frota');?>">Pesquisar</a></li>
            <li><a href="<?php echo base_url('frota/novo');?>">Adicionar Novo</a></li>
            <!--li role="separator" class="divider"></li-->
            <!--li><a href="<?php echo base_url('frota/contacto');?>">A sua opinião</a></li-->
          </ul>
        </li>
